...
def create_role(iam_client):
    print(f'{__file__} - Creating role for CloudTrail log delivery')
...
def add_policy_to_role(iam_client,log_policy_arn):        
    print(f'{__file__} - Attaching policy to role')
    try:
...
def update_trail(boto_session,trail_name,log_group_arn,log_role_arn):
    ...
    print(f'{__file__} - cloudtrail_send_to_cloudwatch.py - Updating trail')
